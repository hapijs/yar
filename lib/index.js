...
exports.register = function (server, options, next) {
    ...
    server.ext('onPreAuth', function (request, reply) {
        ...
        var load = function () {
            ...
            var loadFromCache = settings.errorOnCacheDisconnect || cache.isReady();
    ...
    server.ext('onPreResponse', function (request, reply) {
        ...
        var skipCacheStorage = !settings.errorOnCacheDisconnect && !cache.isReady();
