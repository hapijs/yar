...
module.exports = {
    ...
    register: function (server, options) {
        ...
        server.decorate('server', 'yar', internals.decorateServer(cache));
...
internals.decorateRequest = function (settings, cache) {
    ...
    return function (request) {
        ...
        return new internals.RequestYar(request, settings, cache);
    };
};

internals.decorateServer = function (cache) {

    return new internals.ServerYar(cache);
};

internals.ServerYar = class {
